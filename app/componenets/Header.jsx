...
const Header = () => {
  return (
    <motion.div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex 
    ...
    transition={{duration:0.8, type:'spring', stiffness:100}}>
      ...
      transition={{duration:0.6, delay: 0.3}}>
            I'm Nahom Birhanu  <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>

     <motion.h1 className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'
     initial={{y:-30, opacity: 0}}
     whileInView={{y:0, opacity: 1}}
     transition={{duration:0.8, delay: 0.5}} >
            Full-Stack Web and Mobile App Developer </motion.h1>

            <motion.p className='max-w-2xl mx-auto font-Ovo'
             initial={{opacity: 0}}
             whileInView={{opacity: 1}}
             transition={{duration:0.6, delay: 0.7}} >
                I am a Full-Stack web and Mobile App developer from Addis Ababa, Ethiopia 
                with 2 years of experience in multiple company like Space Science,
                Atlas Computer Solution and Nexus Labs.</motion.p>

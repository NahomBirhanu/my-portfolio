...
const About = ({isDarkMode}) => {
  return (
    ...
    transition={{duration:1}} >
      ...
      transition={{duration:1, delay: 0.3}} >Introduction</motion.h4>

      <motion.h2 className='text-center mb-10 text-5xl font-Ovo'
      initial={{opacity: 0, y:-20}}
      whileInView={{opacity: 1, y:0}}
      ...
      transition={{duration:0.8}}>
        ...
        transition={{duration:0.6, delay: 0.8}}>
          <p className='mb-10 max-w-2xl font-Ovo'>
            I am an experienced Full-Stack and Mobile App developer with over a year of 
            professional expertise in the field. Throughout my career, I have had the 
            privilage of collaborating with prestigious organizations, contributing to 
          ...
          transition={{duration:0.8, delay: 1}}>
            ...
            transition={{duration:1.3, delay: 0.5}}>Tools I Use</motion.h4>
            ...
            transition={{duration:1.5, delay: 0.6}}>
                {toolsData.map((tool,index)=>(
                    <motion.li className='flex items-center justify-center w-12 sm:w-14 aspect-square 

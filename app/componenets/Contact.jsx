...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "2887b557-1650-417d-ba44-42a338e673da");
  ...
  return (
    ...
    transition={{duration:1}} >
      ...
      transition={{duration:0.7, delay: 0.5}} >
        ...
        I'd love to hear from you ! If you have any Question, Comments, or Feedback,
      ...
      transition={{delay:0.9, duration:0.5}} >
        ...
        <motion.textarea rows='6' placeholder='Enter your message' required 
            ...
            whileInView={{y:0, opacity: 1}}
            transition={{duration:1.3, delay: 0.6}}></motion.textarea>

        <motion.button type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white
